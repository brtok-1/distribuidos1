 ...
 * @author Bruno
 */
public class JanelaLeilaoAcontecendo1 extends javax.swing.JFrame {

    private static JanelaLeilaoAcontecendo1 instancia = new JanelaLeilaoAcontecendo1();
    
    private Livro livroLeiloando = new Livro();    
    
    public JanelaLeilaoAcontecendo1() {
        initComponents();
    ...
    public static JanelaLeilaoAcontecendo1 getInstancia() {
        return instancia;
    }

    public static void setInstancia(JanelaLeilaoAcontecendo1 instancia) {
        JanelaLeilaoAcontecendo1.instancia = instancia;
    }
